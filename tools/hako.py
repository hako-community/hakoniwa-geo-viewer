...
REQUIRED_FILES = (
    ...
    ROOT / "src" / "client" / "phase0-mapray-model.html",
    ROOT / "src" / "client" / "mapray-drone-model.html",
    ROOT / "src" / "client" / "src" / "ui.js",
    ROOT / "src" / "client" / "src" / "frame.js",
    ROOT / "src" / "client" / "src" / "mapray_layer.js",
    ROOT / "src" / "client" / "src" / "mapray_model_phase0.mjs",
    ROOT / "src" / "client" / "src" / "mapray_drone_model_layer.mjs",
    ROOT / "src" / "client" / "src" / "mapray_drone_fleet_layer.mjs",
    ROOT / "src" / "client" / "src" / "mapray_drone_pose.mjs",
    ROOT / "src" / "client" / "src" / "phase0_mapray_model_spike.js",
    ROOT / "src" / "client" / "src" / "mapray_drone_model_demo.js",
    ...
    ROOT / "config" / "mapray-model-phase0.json",
    ROOT / "config" / "mapray-drone-model.json",
    ...
    ROOT / "runtime-assets" / "tokyo-tower" / "manifest.json",
    ROOT / "runtime-assets" / "tokyo-tower" / "terrain-grid.json",
    ROOT / "runtime-assets" / "tokyo-tower" / "buildings.xml",
    ROOT / "runtime-assets" / "tokyo-tower" / "buildings-lod1.json",
    ROOT / "runtime-assets" / "tokyo-tower" / "source-manifest.json",
...
def test() -> int:
    ...
    if node:
        for script in (
            ...
            "test_mapray_drone_model_layer.mjs",
            "test_mapray_drone_fleet_layer.mjs",
            "test_mapray_drone_pose.mjs",
            "test_mapray_model_phase0.mjs",
...
def smoke() -> int:
    ...
    checks = (
        ...
        ("/src/client/phase0-mapray-model.html", "Mapray 0.9.6 ModelEntity Phase 0"),
        ("/src/client/mapray-drone-model.html", "Mapray 0.9.6 Drone Model Demo"),
        ...
        ("/src/client/src/mapray_model_phase0.mjs", "advanceRotorPhases"),
        ("/src/client/src/mapray_drone_model_layer.mjs", "MaprayDroneModelLayer"),
        ("/src/client/src/mapray_drone_fleet_layer.mjs", "MaprayDroneFleetLayer"),
        ("/src/client/src/mapray_drone_pose.mjs", "hakoniwaRpyToMaprayOrientation"),
        ("/src/client/src/phase0_mapray_model_spike.js", "mapray_drone_model_demo.js"),
        ("/src/client/src/mapray_drone_model_demo.js", "__maprayDroneModelDiagnostics"),
        ...
        ("/config/mapray-model-phase0.json", "propellerDatasetId"),
        ("/config/mapray-drone-model.json", "propellerDatasetId"),
        ...
        ("/runtime-assets/tokyo-tower/manifest.json", "tokyo-tower"),
        ("/runtime-assets/tokyo-tower/terrain-grid.json", "modelHeightsM"),
        ("/runtime-assets/tokyo-tower/buildings.xml", "body_bldg_"),
        ("/runtime-assets/tokyo-tower/buildings-lod1.json", "measuredHeight"),
        ("/runtime-assets/tokyo-tower/source-manifest.json", "GSIGEO2011"),
